    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <div id="carouselExampleIndicators" className="carousel slide carousel-photos">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src="http://www.snut.fr/wp-content/uploads/2015/12/image-de-nature-9.jpg" className="d-block w-100" alt="..."/>
                        </div>
                ...
                <img src="http://www.snut.fr/wp-content/uploads/2015/12/image-de-nature-9.jpg" alt="..." className="pub-header"/>
                <img src="http://www.snut.fr/wp-content/uploads/2015/12/image-de-nature-9.jpg" alt="..." className="pub-header"/>
                <div>
                ...
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card">
                            <img src="http://www.snut.fr/wp-content/uploads/2015/12/image-de-nature-9.jpg" className="card-img-top" alt="..."/>
                ...
                <img src="http://www.snut.fr/wp-content/uploads/2015/12/image-de-nature-9.jpg" alt="..." className="pub-footer-1"/>
                <img src="http://www.snut.fr/wp-content/uploads/2015/12/image-de-nature-9.jpg" alt="..." className="pub-footer-2"/>
